...
import com.spiderindia.departmentsofhighway.Adapter.CulvertAdapter;
...
public class CULVETS extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_culvets);
      ...
      /*  recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(CULVETS.this,CulvertFormActivity.class);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(CULVETS.this,CulvertFormActivity.class));
            }
        });
    ...
    private void loadRecyclerView(String linkId) {
        ...
        Call<CulvertResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .getCulvertDetails(paramObject.toString());

        call.enqueue(new Callback<CulvertResponse>() {
            @Override
            public void onResponse(Call<CulvertResponse> call, Response<CulvertResponse> response) {

                CulvertResponse culvertResponse = response.body();
              /*  Intent intent = new Intent();
                intent.putExtra("culvertResponse", culvertResponse);*/

                List<DataItem> arrayLists = culvertResponse.getResult().getData();


                if (arrayLists.isEmpty()) {

                    Toast.makeText(CULVETS.this, "There are no culvert details", Toast.LENGTH_SHORT).show();
                 ...
                 culvertAdapter = new CulvertAdapter(culvertResponse.getResult().getData(), CULVETS.this);
                    recyclerView.setAdapter(culvertAdapter);

            }

            @Override
            public void onFailure(Call<CulvertResponse> call, Throwable t) {

                Toast.makeText(CULVETS.this, t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void loadLinkSpinner(String Roadid) {
        ...
        call.enqueue(new Callback<LinkResponse>() {
            ...
            public void onResponse(Call<LinkResponse> call, Response<LinkResponse> response) {
                ...
                /*spinnerLink.setAdapter(new ArrayAdapter<String>(CULVETS.this, R.layout.support_simple_spinner_dropdown_item, linkArraylist));*/

                if (!linkArraylist.isEmpty())
                {
                    final ArrayAdapter<String> spinner_link_adapter = new ArrayAdapter<String>(CULVETS.this,R.layout.custom_spinner, linkArraylist);
            ...
            public void onFailure(Call<LinkResponse> call, Throwable t) {
              //  Toast.makeText(CULVETS.this, "", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void loadRoadSpinner() {
        ...
        call.enqueue(new Callback<RoadResponse>() {
            ...
            public void onResponse(Call<RoadResponse> call, Response<RoadResponse> response) {
                ...
                /*spinnerRoad.setAdapter(new ArrayAdapter<String>(CULVETS.this, R.layout.support_simple_spinner_dropdown_item, roadarraylist));*/

                final ArrayAdapter<String> spinner_road_adapter = new ArrayAdapter<String>(CULVETS.this,R.layout.custom_spinner, roadarraylist);
            ...
            public void onFailure(Call<RoadResponse> call, Throwable t) {
                Toast.makeText(CULVETS.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (id == R.id.road)
        {
            ...
            Toast.makeText(CULVETS.this, RoadId, Toast.LENGTH_SHORT).show();
            linkArraylist.clear();
    ...
    private void loadCircleSpinner() {
        ...
        circleResponseCall.enqueue(new Callback<CircleResponse>() {
            ...
            public void onResponse(Call<CircleResponse> call, Response<CircleResponse> response) {
                ...
                {
                    final ArrayAdapter<String> spinner_circle_adapter = new ArrayAdapter<String>(CULVETS.this,R.layout.custom_spinner, circleArrayList);
            ...
            public void onFailure(@NonNull Call<CircleResponse> call, @NonNull Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(CULVETS.this, "circle : "+ t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void loadDivisionSpinner() {
        ...
        divisionResponseCall.enqueue(new Callback<DivisionResponse>() {
            ...
            public void onResponse(Call<DivisionResponse> call, Response<DivisionResponse> response) {
                ...
                {
                    final ArrayAdapter<String> spinner_division_adapter = new ArrayAdapter<String>(CULVETS.this,R.layout.custom_spinner, divisionArrayList);
            ...
            public void onFailure(Call<DivisionResponse> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(CULVETS.this, "division"+t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void loadSubdivisionSpinner() {
        ...
        subdivisionResponseCall.enqueue(new Callback<SubdivisionResponse>() {
            ...
            public void onResponse(Call<SubdivisionResponse> call, Response<SubdivisionResponse> response) {
                ...
                {
                    final ArrayAdapter<String> spinner_subdivision_adapter = new ArrayAdapter<String>(CULVETS.this,R.layout.custom_spinner, subdivisionArrayList);
            ...
            public void onFailure(Call<SubdivisionResponse> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(CULVETS.this, "Subdivision "+t.getMessage(), Toast.LENGTH_SHORT).show();
