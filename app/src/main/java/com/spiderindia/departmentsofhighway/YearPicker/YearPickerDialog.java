 ...
 */
 public class YearPickerDialog implements Dialog.OnClickListener {
    ...
    /**
     * Creates a new YearPickerDialog object that represents the dialog for
     * picking year and month.
     *
     * @param context           The application's context.
     * @param onDateSetListener Listener for user's date picking.
     */
    public YearPickerDialog(Context context, Calendar calendar, OnDateSetListener onDateSetListener) {
        this(context, onDateSetListener, -1, -1, calendar);
    }

    public YearPickerDialog(Context context, OnDateSetListener onDateSetListener, Calendar calendar) {
        this(context, onDateSetListener, -1, -1, calendar);
    }
     ...
     */
    public YearPickerDialog(Context context, OnDateSetListener onDateSetListener, Calendar calendar, int theme) {
     ...
     */
    public YearPickerDialog(Context context, OnDateSetListener onDateSetListener, int theme,
    ...
    private void build() {
        ...
        final View titleView = layoutInflater.inflate(R.layout.view_dialog_title_year, null, false);
        //Inflating custom content view.
        final View contentView = layoutInflater.inflate(R.layout.view_year_picker, null, false);
